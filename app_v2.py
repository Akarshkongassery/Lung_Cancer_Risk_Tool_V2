...
APP_TITLE = "Respiratory Risk & Referral Support"
APP_VERSION = "UI prototype 2.0"
...
def collect_assessment() -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    with st.expander("5 · Clinical findings"):
        ...
        performance = c1.selectbox("General functional status", ["Not recorded", "Unchanged", "Mildly reduced", "Significantly reduced"])
...
def main() -> None:
    ...
    st.markdown(
        ...
        '<p>Decision support for patients presenting to primary care with respiratory symptoms</p></div>',
        unsafe_allow_html=True,
    )
